...
from hydrangea.cmds.init_funcs import check_keys, hydrangea_init
...
if getattr(sys, "frozen", False):
    name_map = {
        ...
        "hydrangea_seeder_dns": "hydrangea_seeder_dns",
    }
...
class WebSocketServer:
    ...
    async def exit(self) -> Dict[str, Any]:
        ...
        log.info("hydrangea daemon exiting in 5 seconds")
