...
from hydrangea.wallet.puzzles.p2_conditions import puzzle_for_conditions
from hydrangea.wallet.puzzles import singleton_top_layer
from hydrangea.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - hydrangea.pools.pool_puzzles.py
    - hydrangea.wallet.puzzles.pool_member_innerpuz.clvm
    - hydrangea.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
