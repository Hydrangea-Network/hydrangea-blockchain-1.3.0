...
from hydrangea.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xhg"), encode_puzzle_hash(new_ph_2, "xhg"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xhg"))
