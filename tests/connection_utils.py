...
async def disconnect_all_and_reconnect(server: HydrangeaServer, reconnect_to: HydrangeaServer) -> bool:
...
async def add_dummy_connection(
    server: HydrangeaServer, dummy_port: int, type: NodeType = NodeType.FULL_NODE
...
async def connect_and_get_peer(server_1: HydrangeaServer, server_2: HydrangeaServer) -> WSHydrangeaConnection:
    """
