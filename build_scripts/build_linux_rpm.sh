...
if [ "$REDHAT_PLATFORM" = "x86_64" ]; then
	...
	# Disables build links from the generated rpm so that we dont conflict with other packages. See https://github.com/HydrangeaBlockchain/hydrangea-blockchain/issues/3846
  ...
  --arch "$REDHAT_PLATFORM" --options.version $HYDRANGEA_INSTALLER_VERSION \
