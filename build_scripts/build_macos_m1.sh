...
--appVersion=$HYDRANGEA_INSTALLER_VERSION
LAST_EXIT_CODE=$?
...
if [ "$NOTARIZE" ]; then
  ...
  --hardened-runtime=true --provisioning-profile=hydrangeablockchain.provisionprofile \
...
electron-installer-dmg dist/Hydrangea-darwin-arm64/Hydrangea.app Hydrangea-$HYDRANGEA_INSTALLER_VERSION-arm64 \
