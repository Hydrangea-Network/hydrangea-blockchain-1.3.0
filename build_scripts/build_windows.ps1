...
Write-Output "   ---"
Write-Output "Get HYDRANGEA_INSTALLER_VERSION"
# The environment variable HYDRANGEA_INSTALLER_VERSION needs to be defined
$env:HYDRANGEA_INSTALLER_VERSION = python .\build_scripts\installer-version.py -win
...
Write-Output "   ---"
Write-Output "Build hydrangea-blockchain wheels"
Write-Output "   ---"
pip wheel --use-pep517 --extra-index-url https://pypi.chia.net/simple/ -f . --wheel-dir=.\build_scripts\win_build .

Write-Output "   ---"
Write-Output "Install hydrangea-blockchain wheels into venv with pip"
Write-Output "   ---"
...
Write-Output "pip install hydrangea-blockchain"
pip install --no-index --find-links=.\win_build\ hydrangea-blockchain
...
electron-packager . Hydrangea --asar.unpack="**\daemon\**" --overwrite --icon=.\src\assets\img\hydrangea.ico --app-version=$packageVersion
Write-Output "   ---"
