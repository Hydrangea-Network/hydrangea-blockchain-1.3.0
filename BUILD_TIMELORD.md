...
required to run a [Timelord](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/blob/main/install-timelord.sh)
