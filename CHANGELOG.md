...
Farmers rejoice: today's release integrates two plotters in broad use in the Hydrangea community: Bladebit, created by @harold-b, and Madmax, created by @madMAx43v3r. Both of these plotters bring significant improvements in plotting time. More plotting info [here](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki/Alternative--Plotters).
...
- Performance improvements for nodes to support higher transaction volumes, especially for low powered devices like RaspBerry Pi. Full details at [#9050](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/pull/9050).
...
We have some great improvements in this release: We launched our migration of keys to a common encrypted keyring.yaml file, and we secure this with an optional passphrase in both GUI and CLI. We've added a passphrase hint in case you forget your passphrase. More info on our [wiki](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki/Passphrase-Protected-Hydrangea-Keys-and-Key-Storage-Migration). We also launched a new Chialisp compiler in clvm_tools_rs which substantially improves compile time for Chialisp developers. We also addressed a widely reported issue in which a system failure, such as a power outage, would require some farmers to sync their full node from zero. This release also includes several other improvements and fixes.

### Added

- Added support for keyring migration from keychain, and the addition of passphrase support. Learn more at our [wiki](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki/Passphrase-Protected-Hydrangea-Keys-and-Key-Storage-Migration).
...
- Switched IP address lookup to first use Hydrangea's service ip.http://hydrangea.website/.
...
- Thanks to @yshklarov for help fixing [#7273](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/issues/7273), which bundled CA store to support pools for some farming systems, including M1 Apple computers. This enables those machines to properly connect to pools, and fixes the issue.
...
- You should review the [release notes for v1.0.2](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/releases/tag/1.0.2) but we especially want to point out that wallet sync is much faster than in 1.0.1 and earlier versions.
...
- Some users can't plot in the GUI in MacOS Big Sur - especially on M1. See issue [1189](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/issues/1189)
...
- We have moved to a new and much higher scalability download.http://hydrangea.website/ to support the mainnet launch flag and additional download demand.
...
- Hydrangea wheels not on Pypi and some dependecies not found there also are now on pypi.http://hydrangea.website/.
...
- Python root CA certificates have issues so we have added the Mozilla certificate store via curl.se and use that to connect to backup.http://hydrangea.website/ via https, for example.
...
- The entire CLI has been ported to [Click](https://click.palletsprojects.com/en/7.x/). Huge thanks to @jespino for the big assist and @unparalleled-js for the [recommendation and the initial start](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/issues/464). This will make building out the CLI much easier. There are some subtle changes and some shortcuts are not there anymore. `hydrangea -h` and `hydrangea SUBCOMMAND -h` can be your guide.
...
- This is an errata release for Release Candidate 1. There were a couple of things that did not smoothly migrate from the Beta versions. Please make sure you also consult the [release notes for RC-1](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/releases/tag/1.0rc1) was well.
...
- There is now remote UI support. [Documents](https://github.com/HydrangeaBlockchain/hydrangea-blockchain-gui/blob/main/remote.md) will temporarily live in the repository but have moved to the [wiki](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki/Connecting-the-UI-to-a-remote-daemon). Thanks to @dkackman for this excellent addition!
...
- The GUI is now in a separate submodule repository from hydrangea-blockchain, [hydrangea-blockchain-gui](https://github.com/HydrangeaBlockchain/hydrangea-blockchain-gui). The installers and install scripts have been updated and it continues to follow the same install steps. Note that the GUI directory will now be `hydrangea-blockchain-gui`. The workflow for this may be "touch and go" for people who use the git install methods over the short term.
...
- We have made the "Help Translate" button in the GUI open in your default web browser and added instructions for adding new translations and more phrases in existing translations at that [URL](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/tree/main/electron-react/src/locales). Try the "Help Translate" option on the language selection pull down to the left of the dark/light mode selection at the top right of the GUI.
...
- We are down to only one sub dependency that does not ship binary wheels for all four platforms. The only platform still impacted is ARM64 (generally Raspberry Pi) but that only means that you still need the minor build tools as outlined on the [wiki](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki/Raspberry-Pi).
...
- Last Attempted Proof is now fixed. This will show you the last time one of your plots passed the [plot filter](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it).
...
- There is a lot more information and explanation of the new consensus algorithm in the New Consensus Working Document linked from [http://hydrangea.website/](https://hydrangea.website/). Among the improvements this gives the Hydrangea blockchain are a much higher security level against all attacks, more frequent transaction blocks that have less time variation between them and are then buried under confirmations (sub blocks also count towards re-org security) much more quickly.
...
- A segfault caused by memory leaks in bls-library has been fixed. This should end the random farmer and harvester crashes over time as outlined in [Issue 500](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/issues/500).
...
- In the GUI there was [a regression](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/issues/484) that removed the scroll bar on the Plot page. The scroll bar has returned!
...
- Logging had [a regression](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/issues/485) where log level could no longer be set by service.
...
- The GUI now supports translations and localizations. If you'd like to add your language you can see the examples in [the locales directory](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/tree/dev/electron-react/src/locales) of the hydrangea-blockchain repository.
...
- You can now backup your wallet related metadata in an encrypted and signed file to a free service from Hydrangea Network at backup.http://hydrangea.website/. Simply having a backup of your private key will allow you to fully restore the state of your wallet including coloured coins, rate limited wallets, distributed identity wallets and many more. Your private key is used to automatically restore the last backup you saved to the Hydrangea backup cloud service. This service is open source and ultimately you will be able to configure your backups to go to backup.http://hydrangea.website/, your own installation, or a third party's version of it.
...
- Most of the content of README.md and INSTALL.md have been moved to the [repository wiki](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki) and placed in [INSTALL](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki/INSTALL) and [Quick Start Guide](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki/Quick-Start-Guide)
...
- We suggest you take a look at our [Upgrading documentation](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki/Updating-beta-software) if you aren't performing a new install.
...
- Plots of k>=32 are not working for farming, and some broken plots can cause a memory leak. A [workaround is available](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/wiki/Beta-1.4-k=32-or-larger-work-around).
...
- We have revamped the hydrangea management command line. To start a farmer all you have to do is start the venv with `. ./activate` and then type `hydrangea-start-farmer &`. The [README.md](https://github.com/HydrangeaBlockchain/hydrangea-blockchain/blob/main/README.md) has been updated to reflect the new commands.
...
[unreleased]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/1.0beta5...dev
[1.0beta5]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/1.0beta4...1.0beta5
[1.0beta4]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/1.0beta3...1.0beta4
[1.0beta3]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/1.0beta2...1.0beta3
[1.0beta2]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/1.0beta1...1.0beta2
[1.0beta1]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/alpha-1.5.1...1.0beta1
[alpha 1.5.1]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/alpha-1.5...alpha-1.5.1
[alpha 1.5]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/alpha-1.4.1...alpha-1.5
[alpha 1.4.1]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/alpha-1.4...alpha-1.4.1
[alpha 1.4]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/alpha-1.3...alpha-1.4
[alpha 1.3]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/alpha-1.2...alpha-1.3
[alpha 1.2]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/alpha-1.1.1...alpha-1.2
[alpha 1.1.1]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/alpha-1.1...alpha-1.1.1
[alpha 1.1]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/compare/alpha-1.0...alpha-1.1
[alpha 1.0]: https://github.com/HydrangeaBlockchain/hydrangea-blockchain/releases/tag/Alpha-1.0
